...
bool d1Audio::Awake(pugi::xml_node& config)
{
...
// Play a music file
bool d1Audio::PlayMusic(const char* path, float fade_time)
{
	bool ret = true;
...
// Load WAV
unsigned int d1Audio::LoadFx(const char* path)
{
	unsigned int ret = 0;
...
// Play WAV
bool d1Audio::PlayFx(unsigned int id, int repeat)
{
	bool ret = false;
