...
{
	resource_food = (Resources*)App->entity_manager->CreateResource(R_FOOD, fPoint(1419, 1031));
	...
	resource_stone = (Resources*)App->entity_manager->CreateResource(R_STONE, fPoint(1392, 858));	
}
